...
\caption{$GL(2, \mathbb{Z})$ induced tessellation of the configurational space of metric tensors with  $\det{\bf C}=1$ streographically projected on a  Poincaré disk.  The domain $\mathscr D$ highlighted in gray is a minimal periodicity domain.    Black squares  mark  equivalent representations of the same square lattice.}
\label{fig:atlas0}
\end{figure}  
