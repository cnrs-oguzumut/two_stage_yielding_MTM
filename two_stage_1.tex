...
% while red dots denote equivalent triangular (hexagonal) lattices. 
 The structure of the minimal tensorial periodicity domain $D$, 
...
%${\bf F}(\alpha,\theta)={\bf I}+\alpha {\bf R}(\theta){\bf e}_1 \otimes{\bf e}_2$,
 ...
 %\begin{equation} \label{F}
  ...
  %\end{equation}
Such loading was chosen to represent  simple shear along one of the the principal slip direction   with shear amplitude $\alpha$  serving as the loading parameter. 
